...
var AlbumsService = (function () {
    ...
    AlbumsService.prototype.getAlbums = function () {
        return this.http.get('http://api.openweathermap.org/data/2.5/weather?q=toronto&units=metric&APPID=00210233b9ebb9d803b9cfcb463b20ad').map(function (res) { return res.json(); });
    };
